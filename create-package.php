...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="http://localhost/TMS/admin/dashboard.php">Home</a><i class="fa fa-angle-right"></i>Update Package </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Package Price in Rs/Day</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageprice" id="packageprice" placeholder=" Package Price is Rs/Day" required>
									</div>
								</div>
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Package Details and Traveller's Requirements</label>
									<div class="col-sm-8">
